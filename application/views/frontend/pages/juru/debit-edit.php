<div id="main"> 
    ...
    ?>
    <?php echo form_open('pimpinan-debit-edit-action', '', array('id' => $update->id)); ?>
    <table class="table-form">
        ...
        <tr>
            ...
            <td class="<?php echo form_error('date') ? 'has-error' : ''; ?>">
                <input type="text" id="date" name="date" value="<?php echo set_value('date', $update->date) ?>"> 
        ...
        <tr>
            ...
            <td class="<?php echo form_error('right') ? 'has-error' : ''; ?>">
                <input type="number" step="any" name="right" value="<?php echo set_value('right', $update->right) ?>">
        ...
        <tr>
            ...
            <td class="<?php echo form_error('left') ? 'has-error' : ''; ?>">
                <input type="number" step="any" name="left" value="<?php echo set_value('left', $update->left) ?>">
        ...
        <tr>
            ...
            <td class="<?php echo form_error('limpas') ? 'has-error' : ''; ?>">
                <input type="number" step="any" name="limpas" value="<?php echo set_value('limpas', $update->limpas) ?>">
