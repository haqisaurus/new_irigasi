...
<div id="main"> 
	...
	<a href="<?php echo site_url('pengamat-rencana-list') ?>" style="float: right;"><button><span class="fa fa-info"></span> List rencana</button></a>
	<br>
	<br>
	<?php echo form_open('pengamat-kalkulasi-rencana', '' ); ?>
	<?php 
	$regionOption = array();
