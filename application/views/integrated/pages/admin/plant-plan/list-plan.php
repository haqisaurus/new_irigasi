...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Daftar rencana tanam</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="<?php echo site_url('add-data-plan'); ?>" class="btn btn-primary"><span class="fa fa-plus-square"></span> Tambah</a>
                <br>
                <br>
                                    ...
                                    <?php foreach ( $table as $key => $item ): ?>
                                        <?php if ( $key % 2 == 0 ): ?>
                                            <tr class="odd" data-id="<?php echo $item->id ?>">
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url('view-plan/' . $item->id) ?>" class="btn btn-info btn-xs"><span class="fa fa-edit"></span> Kalkulasi</a> 
                                                </td>
                                            </tr>
                                        <?php else: ?>
                                            <tr class="even">
